  ...
  return (
    ...
    "
            ...
            <div className="flex flex-col lg:flex-row gap-[30px] px-[44.5px] md:gap-[60px]">
              <div className="bg-[#F6F6F6] w-full md:min-w-[373px] md:max-w-[373px] md:min-h-[238px] p-[20px] rounded-[10px]">
                <div className="flex gap-[20px] items-center">
                  <div className="bg-[#EAF2FA] rounded-[10px] p-[10px]">
                    <Image src={location} alt="" />
                  </div>
                  <p className="text-[25px] text-[#010101] font-bold font-[family-name:var(--font-bricolage-grotesque)]">
                    Address
                  </p>
                </div>
                <div className="text-[#656565] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-bold">
                  KoroRyde Headquarters
                </div>
                <div className="text-[#656565] leading-[150%] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-normal">
                 55e Adebisi Omotola close, VI behind ZenithHQ
                </div>
              </div>
              ...
              <div className="bg-[#F6F6F6] w-full md:min-w-[373px] md:max-w-[373px] md:min-h-[238px] p-[20px] rounded-[10px]">
                ...
                <div className="flex flex-col mt-[40px]">
                  <div>
                    {" "}
                    <span className="text-[#aa2d2d] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-bold">
                      Customer Support:
                    </span>{" "}
                    <span className="text-[#656565] leading-[150%] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-normal">
                      +234 8132448005
                    </span>
                  </div>
                  <div>
                    <span className="text-[#656565] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-bold">
                      Driver Support:
                    </span>{" "}
                    <span className="text-[#656565] leading-[150%] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-normal">
                    +234 8132448005
          ...
          <div className="bg-[#F6F6F6] px-[20px] md:px-[100px] max-w-[839px] mx-auto mt-[100px] py-[50px]">
            <p
              className="text-[#030303] text-[50px] font-bold leading-[150%]
    font-[family-name:var(--font-bricolage-grotesque)] text-center [text-shadow:3px_2px_0px_0px_#2D7CD0]
    "
            >
              Contact Form
            </p>
            <p className="max-w-[1118px] mt-[30px] mx-auto flex flex-col gap-[20px] text-[18px] font-normal leading-[150%] text-center  text-[#656565]">
              Still have more questions? fill out the form below, and our team
            ...
            <div className="mt-[50px] flex flex-col gap-[20px]">
              ...
              <button className="bg-[#2D7CD0] py-[16.5px]  rounded-[10px] text-[#FDFDFD] text-[18px] font-bold w-fit mx-auto px-[118px]">
                Submit
              </button>
            </div>
          </div>
...
const Contact = ({ icon, title, details }) => {
  <div className="bg-[#F6F6F6] p-[20px] rounded-[10px]">
    ...
    <div className="text-[#656565] text-[18px] font-[family-name:var(--font-bricolage-grotesque)] mt-[40px] font-normal">
      {details}
    </div>
  </div>;
};
