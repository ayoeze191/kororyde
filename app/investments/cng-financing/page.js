      ...
      <div className="font-[family-name:var(--font-bricolage-grotesque)]">
        ...
        >
          ...
          <p className="text-[#2D7CD0] text-[30px] lg:text-[50px] font-bold pt-[50px]  mx-auto lg:pt-[100px]  lg:w-full text-center font-[family-name:var(--font-bricolage-grotesque)] [text-shadow:3px_2px_0px_#252B42]">
            <span className="text-red-500">Few Slots Left</span> - Convert To
            CNG & SAVE Over
            <br /> 500000 Monthly on{" "}
            <span className="font-bold underline">Fuel | Safe & Secure</span>
          </p>
          <div className="mt-[100px] mx-auto px-[20px] sm:px-[30px] lg:px-[140px] flex-col md:flex-row flex items-center gap-[68px]">
            ...
            <p className="w-full md:w-1/2">
              ...
              <p className="text-[18px] font-[family-name:var(--font-bricolage-grotesque)] text-center text-[#656565] mt-[20px]">
                ...
                <br />
                CNG Conversion Costs: ₦1.2M – ₦2.5M (Varies by Car Type)
                <br />
                We understand that not everyone can afford this upfront—that’s
                why we’re making it happen for 500 drivers!
                <br />
                📢 KoroRYDE’s CNG Finance Scheme now offers you a chance to
                convert your car and pay over 12 months—no financial strain,
                just long-term savings!
              </p>
            </p>
          </div>
          <div className="mt-[100px] mx-auto px-[20px] sm:px-[30px] lg:px-[140px]">
            ...
            <div className="flex gap-[20px] md:gap-[30px] lg:gap-[60px] flex-col md:flex-row mx-auto w-fit mt-[50px]">
              <div className=" bg-[#CD7F32] rounded-[10px] items-center text-[#FEFEFE] flex flex-col h-[300px] p-[20px] w-full md:w-fit">
                <p className="text-[25px] font-bold leading-[150%] text-center">
                  What is the CNG Finance Scheme?
                </p>
                <ul className="text-center mt-[20px] ">
                  {/* <li className="text-[18px] font-normal leading-[150%]">Invest ₦2.5</li> */}
                  <li>
                    It’s a scheme that gives you access to finance to convert
                    your car to CNG immediately. With the high cot of fuel, it’s
                    no doubt the cost of running your car is extremely eating
                    deep into your profit; the way to go is CNG, which is more
                    secured, safer and easy to maintain.
                  </li>
                </ul>
              </div>

              <div className=" bg-[#B59900] rounded-[10px] items-center text-[#FEFEFE] flex flex-col h-[300px] p-[20px] w-full md:w-fit">
                <p className="text-[25px] font-bold leading-[150%]">
                  How much do I pay back?
                </p>
                <ul className="text-center mt-[20px] ">
                  {/* <li className="text-[18px] font-normal leading-[150%]">Invest ₦2.5</li> */}
                  <li>
                    Depending on the cost based on your car model; if it cost
                    say N1.2m; you’re expected to pay N40,000 weekly for
                    12months. With 60-70% savings on fuel, you’ll be saving an
                    extra 100-120k weekly from which you pay your 40k weekly
                    remittance; that’s an extra 60-80k take-home weekly.
                  </li>
                </ul>
              </div>
              <div className=" bg-[#2ec553] rounded-[10px] items-center text-[#FEFEFE] flex flex-col h-[300px] p-[20px] w-full md:w-fit">
                <p className="text-[25px] font-bold leading-[150%] text-center">
                  When will the conversion be done?
                </p>
                <ul className="text-center mt-[20px] ">
                  {/* <li className="text-[18px] font-normal leading-[150%]">Invest ₦2.5</li> */}
                  <li>
                    Once your initial deposit is made and every other
                    requirements have been met, conversion is done in 1-3 days.
                    Click HERE to begin.
                  </li>
                </ul>
              </div>
            ...
            <p className="w-full md:w-1/2">
              ...
              <p className="text-[18px] font-[family-name:var(--font-bricolage-grotesque)] text-center text-[#656565] mt-[20px]">
                ...
                <p className="text-[#C20000] mt-[20px] font-bold">
                  🚀 Limited slots available! Don’t miss this opportunity to
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <p className="text-[18px] mt-[50px]">
                  Start earning{" "}
                  <span className="text-[#2D7CD0] ">5% Monthly</span> Interest
                  Pay <span>In 12 months</span>
                </p>
              </div>
            </p>
          </div>
          <div className="footerBg py-[140px]">
            ...
            <div className="mt-[50px] flex flex-col gap-[20px] md:w-[874px] mx-auto bg-[#FEFEFE] px-[50px] py-[50px] rounded-[10px]">
              ...
              <div className="py-[11.5px] px-[30.5px] border-[1px] rounded-[10px] border-[#656565] ">
                <input
                  type="number"
                  placeholder="Referral Phone Number (Crosscheck to be sure this is correct)
"
                  className="outline-0 border-0 w-full"
                />
              </div>
          ...
          <div className="bg-[#010101] flex flex-col items-center text-white ">
            <p className="max-w-[1258px] text-center text-base sm:text-[18px]  md:text-[25px] py-[77px] font-normal px-[20px]">
              ...
              reliable delivery service for your goods, we’ve got you covered.
            </p>
