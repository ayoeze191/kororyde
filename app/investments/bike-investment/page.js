  ...
  return (
    <OverallLayout>
      <div className="font-[family-name:var(--font-bricolage-grotesque)]">
        <div
          className="lg:min-h-screen bg-no-repeat bg-cover lg:px-[112px] lg:py-[64px]  pt-[60px]   "
          style={{}}
        >
          ...
          <div className="mt-[100px] mx-auto px-[20px] sm:px-[30px] lg:px-[140px] flex-col md:flex-row flex items-center gap-[68px]">
            ...
            <p className="w-full md:w-1/2">
              <p className="font-bold text-center text-[25px] leading-[150%] font-[family-name:var(--font-bricolage-grotesque)]">
                Why You Need To Invest in KoroRYDE’s
                <br />
                EV Bike Initiative?
              </p>
              <p className="text-[18px] font-[family-name:var(--font-bricolage-grotesque)] text-center text-[#656565] mt-[20px]">
                ...
                KoroRYDE is leading the charge! With eco-friendly EV bikes,
                we’re not just transforming mobility, we’re creating a
                profitable investment opportunity for smart investors like you.
                <br />
                <p className="text-center mt-[20px]">
                  ✅ Earn up to ₦1.5M in 24 months <br />
                  ✅ Low-risk, high-reward investment model <br />
                  ✅ Sustainable and future-proof business
                  <br />
                  ✅ Be part of Nigeria’s green mobility revolution
                </p>
              </p>
            </p>
          </div>
          ...
          <div className="mt-[100px] mx-auto px-[20px] sm:px-[30px] lg:px-[140px] flex flex-col md:flex-row items-center gap-[20px] md:gap-[68px] mb-[100px]">
            ...
            <p className="w-full md:w-1/2">
              ...
              <p className="text-[18px] font-[family-name:var(--font-bricolage-grotesque)] text-center text-[#656565] mt-[20px]">
                The future of transportation is electric, sustainable, and
                profitable. KoroRYDE is pioneering this shift by combining clean
                energy mobility with smart investment opportunities. Don’t miss
                out on this once-in-a-lifetime opportunity to earn and drive the
                future!
              ...
              <div className="py-[11.5px] px-[30.5px] border-[1px] rounded-[10px] border-[#656565]">
                <select className="outline-0 border-0 w-full bg-transparent text-[#656565]">
                  <option value="" disabled selected className="w-full">
                    Are you interested in investing in 1 or more E-bikes?
                  </option>
