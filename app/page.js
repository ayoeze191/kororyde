...
const commitments = [
  {id: 1, image: safeandaffordavle, benefits: "Safe and affordable transportation", text: ["At KoroRyde, we are committed to providing a safe, reliable, and budget-friendly transportation experience for every passenger. Whether you're commuting to work, heading out for an event, or managing business logistics, we ensure that affordability never comes at the expense of safety","Our drivers undergo rigorous screening and training, while our vehicles are regularly inspected to meet high safety standards. With transparent pricing, real-time tracking, and 24/7 customer support, you can ride with confidence, knowing you're in good hands", "Choose KoroRyde—where your safety and affordability go hand in hand"]},
  {
    id:2, image: green, benefits: "CNG-powered cars and EV bikes.", text: ["At KoroRyde, we are committed to sustainable and eco-friendly transportation. Our CNG-powered cars and electric bikes (EV bikes) are designed to reduce carbon emissions while providing a smooth, efficient, and cost-effective ride", "By integrating clean energBy integrating clean energy solutions, we’re not just helping the environment, we’re also ensuring fuel efficiency, lower operational costs, and a quieter, more comfortable ride for our customers. Whether you're commuting daily or running errands, our green fleet guarantees a safer, healthier, and more sustainable way to travel.", "Ride with KoroRyde and join us in shaping the future of clean mobility! "]
  },
  {
    id:3,  image: delivery, benefits: "Offering a seamless, fast delivery service.", text: ["Need to send a package quickly and reliably? KoroRyde offers a seamless, fast, and secure delivery service designed to get your items where they need to be, without delays.","With our real-time tracking, efficient dispatch system, and reliable couriers, we ensure your parcels, documents, and goods reach their destination safely and on time. Whether it’s same-day delivery or scheduled drop-offs, we make logistics hassle-free and cost-effective for businesses and individuals alike.", "Trust KoroRyde for swift, stress-free deliveries—because every package matter"]
  },
  {
   id:4, image: investment, benefits: "Investment opportunities for individuals and businesses.", text: ["KoroRyde isn’t just about transportation, it’s also a platform for smart investments. We offer exciting opportunities for individuals and businesses to earn passive income by investing in our growing fleet of vehicles.","Whether you’re looking to own and lease cars for ride-hailing, invest in CNG-powered vehicles and EV bikes, or partner with us for logistics and delivery services, KoroRyde provides a transparent and profitable model with high returns and low risk.", "Join us in shaping the future of mobility while securing steady financial growth. Invest with KoroRyde today and ride the wave of success!"]
  }
]
